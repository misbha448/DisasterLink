...
DisasterLink solves two major challenges in disaster management:

### ✅ **1. Early Earthquake Prediction (Python + ML + FastAPI)**

A machine learning model processes historical seismic patterns and predicts the likelihood of earthquakes.
The ML engine exposes a **FastAPI endpoint** that the main backend consumes to display alerts and insights.

### ✅ **2. Smart Disaster Response & Coordination (Node.js + Express + MongoDB)**

A centralized platform that enables victims to request help, volunteers to respond, NGOs to allocate resources, and officers/admins to manage operations — all in real time.
...
* ML model trained on global seismic datasets
* Real-time prediction API using **FastAPI**
* Feature processing: magnitude, depth, location patterns
* Returns risk level (Low / Moderate / High)
* Integrated with main backend dashboards
...
* Geo-based help request tracking
...
* Integrates with ML FastAPI service
