...
const generateChatResponse = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    const predefinedResponses = {
      ...
      'provide me the precautinory measures for earthquake':"Stay prepared by securing your home and keeping an emergency kit ready. During an earthquake, stay calm, drop under a sturdy table, and avoid windows or heavy objects. If outside, move to an open area. After the shaking stops, check for injuries, avoid damaged buildings, and stay alert for aftershocks.",
    };
